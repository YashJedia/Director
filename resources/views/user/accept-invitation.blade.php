...
<head>
    ...
    <title>Accept Invitation - Set Your Password</title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6" action="{{ route('user.invitation.set-password', $invitation->token) }}" method="POST">
            @csrf
            ...
            <div class="text-center">
                <p class="text-xs text-gray-500">
                    By setting your password, you agree to accept this invitation and create your account.
                </p>
            </div>
        </form>
    </div>
