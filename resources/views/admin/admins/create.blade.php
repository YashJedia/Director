...
@section('title', 'Create Admin - GlobalRize Reporting')
...
@section('content')
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 mb-1">Create Admin</h1>
                <p class="text-gray-500">Add a new admin account to the system.</p>
            </div>
        ...
        <form action="{{ route('admin.admins.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    @error('role')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                    <p class="text-gray-500 text-xs mt-1">Super Admins can manage admins and languages. Admins can manage users. Managers have limited access.</p>
                </div>
            ...
            <div class="mt-8 flex justify-end space-x-3">
                ...
                <button type="submit" 
                    ...
                    <i class="fa-solid fa-save mr-2"></i>Create Admin
                </button>
            </div>
        </form>
    </div>
