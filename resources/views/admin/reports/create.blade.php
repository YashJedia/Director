...
@section('content')
<style>
    /* Show Q1 fields by default - visible initially */
    .quarter-field {
        display: table-row;
    }
...
<div class="p-6 bg-white rounded-lg border border-gray-200 shadow-sm">
    ...
    <form action="{{ route('admin.reports.store') }}" method="POST">
        ...
        <div class="overflow-x-auto mb-6 border border-blue-300 rounded-lg">
            <table class="min-w-full border-collapse text-sm">
                ...
                <tbody>
                    ...
                    @foreach(['1' => 'Q1', '2' => 'Q2', '3' => 'Q3', '4' => 'Q4'] as $qNum => $qLabel)
                        ...
                        <!-- Number of Languages -->
                        <tr class="border-b border-gray-200 hover:bg-blue-50 quarter-field" data-quarter="{{ $qLabel }}">
                            <td class="px-4 py-3 font-semibold text-gray-800 bg-gray-50 border-r border-gray-300">Number of Languages</td>
                            <td class="px-4 py-3 border-r border-gray-300"><input type="number" name="languages_end_year" min="0" max="999999" class="table-input" value="{{ old('languages_end_year') }}"></td>
                            <td class="px-4 py-3 border-r border-gray-300"><input type="number" name="languages_goal_year" min="0" max="999999" class="table-input" value="{{ old('languages_goal_year') }}"></td>
                            <td class="px-4 py-3 border-r border-gray-300"><input type="number" name="languages_goal_q{{ $qNum }}" min="0" max="999999" class="table-input goal-input" value="{{ old('languages_goal_q' . $qNum) }}"></td>
                            <td class="px-4 py-3 border-r border-gray-300"><input type="number" name="languages_achieved_q{{ $qNum }}" min="0" max="999999" class="table-input achieved-input" value="{{ old('languages_achieved_q' . $qNum) }}"></td>
                            <td class="px-4 py-3 text-center"><input type="text" readonly class="table-input percentage-display" data-goal-field="languages_goal_q{{ $qNum }}" data-achieved-field="languages_achieved_q{{ $qNum }}" value="N/A"></td>
                        </tr>
                        <!-- Volunteers -->
                        <tr class="border-b border-gray-200 hover:bg-blue-50 quarter-field" data-quarter="{{ $qLabel }}">
