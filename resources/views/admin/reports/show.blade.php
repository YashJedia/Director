...
@section('title', 'View Report - Admin Panel')
...
<div class="w-full flex flex-col items-start px-2 md:px-0">
    ...
    <div class="flex justify-between items-center mb-8 w-full max-w-5xl">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 mb-1">{{ $report->title }}</h1>
            <p class="text-gray-500">Read-only view - Report from {{ $report->user->name ?? 'N/A' }}</p>
        </div>
        <a href="{{ route('admin.dashboard') }}" class="bg-gray-600 hover:bg-gray-700 text-white px-6 py-2 rounded-lg font-medium transition-colors duration-200">
            <i class="fa-solid fa-arrow-left mr-2"></i>Back to Dashboard
        </a>
    </div>

    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 w-full max-w-5xl">
        <!-- Read-only view notice -->
        <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <div class="flex items-start">
                ...
                <div class="text-blue-800 text-sm">
                    ...
                    <p class="text-xs mt-1">This report has been approved and submitted to Super Admin. You can view the details below.</p>
                </div>
            </div>
        </div>
        ...
        <div class="border-b border-gray-200 pb-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <p class="text-gray-900 font-medium">{{ $report->user->name ?? 'N/A' }}</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="text-gray-900 font-medium">{{ $report->submitted_to_super_admin_at?->format('M d, Y H:i') ?? 'N/A' }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200">
            <a href="{{ route('admin.dashboard') }}" class="px-4 py-2 text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg font-medium transition-colors duration-200">
                <i class="fa-solid fa-arrow-left mr-2"></i>Back to Dashboard
            </a>
        </div>
    </div>
